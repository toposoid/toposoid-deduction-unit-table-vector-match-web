...
class HomeControllerSpecJapaneseA extends PlaySpec with BeforeAndAfter with BeforeAndAfterAll with GuiceOneAppPerSuite with DefaultAwaitTimeout with Injecting {
  ...
  val reference2 = Reference(url = "", surface = "証拠データを", surfaceIndex = 0, isWholeSentence = false,
  ...
  val reference3 = Reference(url = "", surface = "証拠データが", surfaceIndex = 0, isWholeSentence = false,
  ...
  val referencePara2Ok = Reference(url = "", surface = "証拠サンプルを", surfaceIndex = 0, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040292480&fileKind=1")
  ...
  val referencePara2Ng = Reference(url = "", surface = "証拠サンプルを", surfaceIndex = 0, isWholeSentence = false,
  ...
  val referencePara3Ok = Reference(url = "", surface = "証拠サンプルが", surfaceIndex = 0, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040410921&fileKind=4")
  ...
  val referencePara3Ng = Reference(url = "", surface = "証拠サンプルが", surfaceIndex = 0, isWholeSentence = false,
  ...
  val referencePara4Ok = Reference(url = "", surface = "証拠サンプルに", surfaceIndex = 1, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032117292&fileKind=0")
  ...
  val referencePara4Ng = Reference(url = "", surface = "証拠サンプルに", surfaceIndex = 1, isWholeSentence = false,
