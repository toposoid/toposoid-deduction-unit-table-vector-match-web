...
class HomeControllerSpecEnglishA extends PlaySpec with BeforeAndAfter with BeforeAndAfterAll with GuiceOneAppPerSuite with DefaultAwaitTimeout with Injecting {
  ...
  val reference2 = Reference(url = "", surface = "data", surfaceIndex = 5, isWholeSentence = false,
  ...
  val reference3 = Reference(url = "", surface = "data", surfaceIndex = 1, isWholeSentence = false,
  ...
  val reference4 = Reference(url = "", surface = "data", surfaceIndex = 5, isWholeSentence = false,
  ...
  val referencePara2Ok = Reference(url = "", surface = "sample", surfaceIndex = 5, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040292480&fileKind=1")
  ...
  val referencePara2Ng = Reference(url = "", surface = "sample", surfaceIndex = 5, isWholeSentence = false,
  ...
  val referencePara3Ok = Reference(url = "", surface = "sample", surfaceIndex = 1, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040410921&fileKind=4")
  ...
  val referencePara3Ng = Reference(url = "", surface = "sample", surfaceIndex = 1, isWholeSentence = false,
  ...
  val referencePara4Ok = Reference(url = "", surface = "sample", surfaceIndex = 5, isWholeSentence = false,
    originalUrlOrReference = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032117292&fileKind=0")
  ...
  val referencePara4Ng = Reference(url = "", surface = "sample", surfaceIndex = 5, isWholeSentence = false,
  ...
  "The specification6" should {
    "returns an appropriate response" in {
      ...
      val paraphraseKnowledge1 = Knowledge(lang=lang, sentence=paraphrase1, extentInfoJson = "{}", knowledgeForTables=List(uploadTable(knowledgeForTablePara1Ng, transversalState)))
      val paraphraseKnowledge2 = Knowledge(lang=lang, sentence=paraphrase2, extentInfoJson = "{}", knowledgeForTables=List(uploadTable(knowledgeForTablePara2Ng, transversalState)))
      val paraphraseKnowledge3 = Knowledge(lang=lang, sentence=paraphrase3, extentInfoJson = "{}", knowledgeForTables=List(uploadTable(knowledgeForTablePara3Ng, transversalState)))
